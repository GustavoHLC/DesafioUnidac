...
import br.com.mybreakfast.cafeDaManha.service.UsuarioService;
...
public class UsuarioController {
	...
	public ResponseEntity <Usuario> Post(@RequestBody Usuario login) {
		
		Usuario usuarioResp = usuarioService.cadastrarUsuario(login);
		try {
	...
	@PutMapping("/alterar")
	public ResponseEntity<Usuario> Put(@RequestBody Usuario login){
		Optional<Usuario> usuarioUpdate = usuarioService.atualizarUsuario(login);
		try {
